...
FLAGS.trackObj = ["person"] #["bicycle", "person", "dog", "car", "motorbike", "truck", "traffic light"]
...
FLAGS.BK_MOG = False # activate background substraction using cv2 MOG substraction,
                        #to help in worst case scenarion when YOLO cannot predict(able to detect mouvement, it's not ideal but well)
